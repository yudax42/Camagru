<?php
    class Form extends Database
    {
        ...
        //send password reinisialiton mail
        public function pass_reini_mail($email,$password)
        {
            $mail_body= "
                <p> Hi,</p>
                ...
                <p>Thank you!</p>
            ";
            if(mail($email,'password reinisialiton',$mail_body,"FROM: $this->adminName@$this->host"))
                return(1);
        }
